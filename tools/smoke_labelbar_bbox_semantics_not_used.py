...
def main():
    ...
    if hits:
        ...
        raise AssertionError(
            "LabelBar supplied-metrics bbox semantics must not be used by render/layout paths "
            "until live Plotchar metrics, TextItem bbox, MultiText bbox, and AdjustGeometry are implemented."
        )

    print("✅ LabelBar supplied-metrics bbox semantics are not used by render/layout paths")
