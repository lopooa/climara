...
def main():
    ...
    if hits:
        ...
        raise AssertionError(
            "LabelBar AdjustGeometry materialization must not be used by render/layout paths yet."
        )

    print("✅ LabelBar AdjustGeometry materialization is not used by render/layout paths")
