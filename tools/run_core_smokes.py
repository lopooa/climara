...
def main():
    ...
    run_if_exists("tools/check_no_incomplete_graphics_claims.py")
    ...
    run_if_exists("tools/smoke_graphics_capabilities.py")
    run_if_exists("tools/smoke_graphics_status_report.py")
