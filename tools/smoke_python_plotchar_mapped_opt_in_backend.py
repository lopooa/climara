...
from climara.graphics._plotchar_mapped_opt_in import (
...
def viewport_state() -> NclWindowViewportState:
...
def main() -> None:
    config = build_ncl_linear_mapped_backend_config(
        window_viewport_state=viewport_state(),
    ...
    try:
        ...
        raise AssertionError("opt-in mapped backend accepted IMAP == 0")

    print("✅ Python Plotchar explicit opt-in mapped backend smoke passed")
