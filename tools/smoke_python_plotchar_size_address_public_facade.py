...
def main() -> None:
    ...
    try:
        ...
        assert "fractional SIZE" in str(exc), str(exc)
    else:
        raise AssertionError("SIZE/address facade accepted fractional SIZE")

    print("✅ Python Plotchar SIZE/address public facade smoke passed")
