...
def main():
    ...
    if hits:
        ...
        raise AssertionError(
            "LabelBar supplied-metrics AdjustGeometry pipeline must not be used by render/layout paths yet."
        )

    print("✅ LabelBar supplied-metrics AdjustGeometry pipeline is not used by render/layout paths")
