...
FORBIDDEN = [
    ...
    "from ._labelbar_adjust_apply import",
...
def main():
    ...
    if hits:
        ...
        raise AssertionError(
            "LabelBar AdjustGeometry apply-to-geometry result must not be used by render/layout paths yet."
        )

    print("✅ LabelBar AdjustGeometry apply-to-geometry result is not used by render/layout paths")
